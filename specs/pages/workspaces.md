...
Shell & navigation: see **[navigation.md](navigation.md) §3.1**. `/workspaces` has no dedicated sidebar item — it is reachable from the dashboard and from project workspace lists. The Dashboard/Projects sidebar (§3.1) remains active.

Related pages: [dashboard.md](dashboard.md) (workspaces shown per-project in accordion). Workspace detail is spec'd in **sections 8–14 of this file** (`/workspaces/:slug`).
...
│  Topbar                                             [Avatar ▾]  │
├──────────────────┬──────────────────────────────────────────────┤
│  Dashboard       │  My Workspaces          [ + Deploy ]        │
│  Explore         │                                              │
│  ── Projects ──  │  ┌── Filters ──────────────────────────┐   │
│  └ my-api    3🟢 │  │ Search   Status ▾   Project ▾       │   │
│  └ frontend  1🟢 │  └─────────────────────────────────────┘   │
│  + New project   │  ┌────────────────────────────────────────┐ │
│  ────────────    │  │  Name  Project  Branch  Status  ⋯      │ │
│  Groups          │  │  ──────────────────────────────────     │ │
│  Profile         │  │  [row]                          [⋯]   │ │
│                  │  │  [row]                          [⋯]   │ │
│                  │  └────────────────────────────────────────┘ │
...
Page root: `PageLayout` with the standard authenticated sidebar (§3.1 context). Content area displays the workspace table.
...
Shell & navigation: see **[navigation.md](navigation.md) §3.3**. The workspace detail sidebar shows the back link to the parent project, the workspace name + status badge, and the Actions section.
...
│  Topbar                                             [Avatar ▾]  │
├──────────────────┬──────────────────────────────────────────────┤
│  ← project-name  │  workspace-name  [RUNNING]  [Private]  📌   │
│  ─────────────── │  project-name › branch-name                  │
│  workspace-name  │                                              │
│  🟢 RUNNING      │  [ Open ↗ ]  [ Stop ]  [ Pin ]  [ Destroy ] │
│  ─────────────── │  ──────────────────────────────────────────  │
│  Overview        │  ┌── Services ──────────────────────────┐   │
│  Services  [2]   │  │  VS Code ↗   App ↗   …              │   │
│  Info            │  └──────────────────────────────────────┘   │
│  ─────────────── │  ┌── Lifecycle ─────────────────────────┐   │
│  ACTIONS         │  │  Started: 3 hours ago                │   │
│  Open ↗          │  │  Last activity: 12 min ago           │   │
│  Stop            │  │  Stops in: 1h 48m  (countdown)      │   │
│  Pin             │  │  Auto-destroy in: 4 days             │   │
│  Keep            │  └──────────────────────────────────────┘   │
│  ─────────────── │  ┌── Info ──────────────────────────────┐   │
│  Destroy…        │  │  Server · Template · Features · URL  │   │
│                  │  └──────────────────────────────────────┘   │
└──────────────────┴──────────────────────────────────────────────┘
```
